...
FORMATS = {
    "DEBUG": f"{Fore.CYAN}[*] {Fore.WHITE}{console_format}{Fore.RESET}",
    "INFO": f"{Fore.CYAN}[+] {Fore.GREEN}{console_format}{Fore.RESET}",
    "WARNING": f"{Fore.CYAN}[!] {Fore.LIGHTYELLOW_EX}{console_format}{Fore.RESET}",
    "ERROR": f"{Fore.CYAN}[-] {Fore.LIGHTRED_EX}{console_format}{Fore.RESET}",
    "CRITICAL": f"{Fore.CYAN}[--]{Fore.RED}{console_format}{Fore.RESET}",
    "TEST": f"{Fore.CYAN}[**]{Fore.LIGHTYELLOW_EX}{console_format}{Fore.RESET}",
    "RUN": f"{Fore.CYAN}[ ] {Fore.WHITE}%(message)s{Fore.RESET}",
    "GOOD": f"{Fore.CYAN}[++]{Fore.LIGHTGREEN_EX}%(message)s{Fore.RESET}"
}
...
def setup_logger(filename="log", con_level=3, file_level=4):
